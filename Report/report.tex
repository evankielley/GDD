...
\item The script consitsts of functions:
\begin{itemize}
\item max\_min\_plot(names)
\item gdd\_plot(names)
\item analyze\_tbase()
\item bokeh\_plot\_temp(fname)
\item bokeh\_plot\_gdd(fname)
\item map\_plot\_nl\_gdd()
\end{itemize}
...
The tree has a base temperature of 10°C and requires 27 GDD to reach maturity.
	\begin{figure}[!htbp]
		\centering
