...
=======
We want to use Python and Bash scripts to analyse growing degree days for three cities
...
\section{Results}
	...
	\begin{figure}[!htbp]
		...
		\caption{\scriptsize Shows the average GDD for Ottawa from 1960 to 2016.}\label{GDDplot}		  
	\end{figure}
